...
public class RabbitMQConstants {
  public final static String FILA_CLIENTE_CRIADO = "CLIENTE_CRIADO";
  ...
  public static final String[] TODAS_FILAS = {
    FILA_CLIENTE_CRIADO, FILA_CRIAR_USUARIO_CLIENTE, FILA_USUARIO_CLIENTE_CRIADO, FILA_CRIAR_CLIENTE
  };
}
