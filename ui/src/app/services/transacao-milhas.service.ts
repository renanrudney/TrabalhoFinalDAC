...
export class TransacaoMilhasService {
  ...
  transactions: TransacaoMilhas[] = [
    ...
    new TransacaoMilhas('00000000000', new Date(2024,2,1,9,0), 6789, 'saida', 'CWB->GRU'),
    new TransacaoMilhas('00000000000', new Date(2024,3,1,22,45), 23456, 'entrada', 'COMPRA DE MILHAS'),
    new TransacaoMilhas('00000000000', new Date(2024,4,1,1,14), 9897, 'saida', 'GRU->CWB')
  ];
