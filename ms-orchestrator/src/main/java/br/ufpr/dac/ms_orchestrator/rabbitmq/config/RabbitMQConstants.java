...
public class RabbitMQConstants {
  ...
  public static final String[] TODAS_FILAS = {
    FILA_CRIAR_USUARIO_CLIENTE, FILA_USUARIO_CLIENTE_CRIADO, FILA_CRIAR_CLIENTE, FILA_VOO_REALIZADO, FILA_VOO_CANCELADO, FILA_RESERVAS_REALIZADO, FILA_RESERVAS_CANCELADO
  };
}
